...
<!-- <div>
    ...
    <div class="col-12 magicCard text-start border p-2" @mouseover="hover = true" @mouseleave="hover = false">
      {{ oracleCard.set_name }}
      <span class="selectable" :title="oracleCard.set_name + ' ' + oracleCard.name" v-if="oracleCard.prices.usd"><a :href="oracleCard.purchase_uris.tcgplayer">${{ oracleCard.prices.usd }}</a></span>
