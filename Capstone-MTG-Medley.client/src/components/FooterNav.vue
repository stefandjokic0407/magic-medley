<template>
  <div class="row fixed-bottom footer-style justify-content-around text-uppercase text-my-light no-select">
    <!-- SECTION Account -->
    <section class="col-1 py-2 text-center">
    ...
    <section class="col-1 py-2 text-center">
      ...
      <div class="text-my-light selectable">Site Tour</div>
